package = "kong-plugin-reskeymod"  -- hint: rename, must match the info in the filename of this rockspec!
...
source = {
  url = "https://github.com/gpetrousov/kong-plugin-reskeymod.git",
  branch = "master",
--  tag = "0.1.0"
...
build = {
  ...
  modules = {
    ...
    ["kong.plugins."..pluginName..".body_modifier"] = "kong/plugins/"..pluginName.."/body_modifier.lua",
  }
}
